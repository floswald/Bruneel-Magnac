...
* Paper is still much work in progress, so many _promises_ indeed. 😉
* I will pose some clarifying questions. 
...
* Is this correct? how does this affect substitution between c and s? made it very difficult for me to follow paper.
...
We don't want to end up thinking _they included $\eta$ because that allows a neat identification proof_. 
